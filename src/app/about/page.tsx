  ...
  return (
    <>
      <Hero
        ...
        image="/images/meditretravel.png"
      ...
      <section className="py-8 sm:py-12">
        <Container>
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_0.95fr] lg:items-start">
            <div className="space-y-4 rounded-[1.6rem] border border-white/75 bg-white/80 p-6 shadow-[0_12px_36px_rgba(23,50,77,0.06)] backdrop-blur-sm">
            ...
            <ImageGrid
              images={[
                { src: "/images/zakynthos.jpeg", alt: "Ionian coastline" },
                { src: "/images/izmir.jpg", alt: "Turkey landscape" },
                { src: "/images/friuili.jpg", alt: "Northern Italy scene" },
              ]}
            />
          </div>
        </Container>
        ...
        <Container>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {focusRegions.map((region) => (
              <article key={region.title} className="rounded-[1.4rem] border border-white/75 bg-white/80 p-6 shadow-[0_12px_36px_rgba(23,50,77,0.06)] backdrop-blur-sm">
